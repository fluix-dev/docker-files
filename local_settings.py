...
ALLOWED_HOSTS = ['judge.theavid.dev']
...
STATIC_ROOT = '/online-judge/static'
...
EVENT_DAEMON_GET = 'ws://judge.theavid.dev/event/'
EVENT_DAEMON_GET_SSL = 'wss://judge.theavid.dev/event/' # Optional
